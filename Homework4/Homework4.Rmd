...
**We can see from this plot, that many of the simulations appear to have similar q-q plot distributions to the real heights data. However, the real heights data seems to follow the normal q-q plot line even more than most of the simulations, especially as values deviate farther from the mean. We can see from both the q-q plot simulations as well as the histogram and normal probability plot that this seems to follow a normal distribution.**  
