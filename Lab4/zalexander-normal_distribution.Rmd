...
**Based on the plot above it appears that the data is slightly skewed relative to a normal distribution (slightly left skewed), however it appears to _nearly_ follow the normal distribution.**
...
**The probability plot for 'fdims$hgt' looks similar to the plots created for the simulated data, where heights fall on or near the line at the mean and on standard deviation from the mean (+/-), and then there is some deviation from the mean at 2 or 3 deviations from the mean (+/-), which are at the tails. The plots do provide evidence that the female heights are nearly normal.**  
